...
export default function ViewRecords({ user }) {
  ...
  return (
    <div className="mx-auto flex flex-col p-4 md:p-6 lg:p-8 bg-gradient-to-r from-purple-900 to-gray-800 text-white rounded shadow-md">
  ...
  <div className="px-10 my-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
        <h3 className="text-2xl font-bold mb-2 text-gray-800">{attendanceSummary.presents || 0}</h3>
        <p className="text-lg font-medium text-gray-800">Present Days</p>
      </div>
      <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
        <h3 className="text-2xl font-bold mb-2 text-gray-800">{attendanceSummary.absents || 0}</h3>
        <p className="text-lg font-medium text-gray-800">Absent Days</p>
      </div>
      <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
        <h3 className="text-2xl font-bold mb-2 text-gray-800">{attendanceSummary.leaves || 0}</h3>
  ...
  <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-4 text-gray-800">
    <input
      type="date"
      value={fromDate || ""}
