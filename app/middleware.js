...
export function middleware(req) {
  ...
  try {
    ...
    const url = req.nextUrl.pathname; // Next.js API routes (specifically middleware) that gives you the path part of the incoming request URL — excluding the domain, query string, or hash.
